...
function checkInLookup(item) {
    ...
    queryHandler(global_vars.username, global_vars.realpass, "http://192.168.10.16:3001", "parts", item, "", "", "GET", "checkInLookup", "");
    item = item.toString()
    item = item.slice(0,-1)
    ...
    queryHandler(global_vars.username, global_vars.realpass, "http://192.168.10.16:3001", "stock_entries", "", "", stockstring, "GET", 'checkInHistory', item);
}
...
//                    console.log("Low Stock: " + arr["lowStock"]);
                    ...
                    console.log("ayy", arr['stockLevel'])
                    if (arr['stockLevel']) {
